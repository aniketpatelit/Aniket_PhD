...
# # Setup the stream
# stream = FileStream("C:\Users\Admin\Downloads\Homomorphic-Encryption-master\Homomorphic-Encryption-master/employee_data.csv")
class AdaptiveXGBoostClassifier(BaseSKMObject, ClassifierMixin):
    ...
    def __init__(self,
        ...
        XGBoost algorithm for evolving data 
        s. AXGB creates new members
